...
# Takes in 1.0/data as that is where all the files are located to merge it
def merge_dataset(data_dir="1.0/data"):
...
def main():
    ...
    df = merge_dataset()
    # Reviewing different columns and first few rows of dataset 
    print("STEP ONE")
    print(df.columns)
    print(df.head())
